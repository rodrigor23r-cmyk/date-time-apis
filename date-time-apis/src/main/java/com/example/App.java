...
public class App {
	public static void main(String[] args) {
		 ...
		 * builder es un método Factory LocalDate lo es también
		 * https://docs.oracle.com/javase/tutorial/datetime/overview/naming.html
		 * https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/time/
		 * temporal/TemporalAdjusters.html
		 */
		 ...
		 */
		System.out.println(ChronoUnit.DAYS.between(fechaNacimiento, hoy));
		// chronoUnit es un long primitivo

		// https://docs.oracle.com/javase/tutorial/datetime/iso/period.html
		System.out.println(Period.between(fechaNacimiento, hoy)); // .getYears());
		...
		Period p = Period.between(hoy, proxCumple);
		long p2 = ChronoUnit.DAYS.between(hoy, proxCumple);
		System.out.println("Faltan " + p.getMonths() + " meses, y " + p.getDays()
				+ " días para tu prox. cumple. (" + p2 + " días en total)");
